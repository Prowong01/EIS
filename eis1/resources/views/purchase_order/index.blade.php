                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{ $purchaseorder->PurchaseRequest->Product->p_name }}</a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-end pe-0" data-order="15">
                                <span class="fw-bold ms-3">{{ $purchaseorder->PurchaseRequest->Supplier->sup_name }}</span>
                            </td>
                            <!--end::Qty=-->
                            <!--begin::Price=-->
                            <td class="text-end pe-0">
                                <span class="fw-bold text-dark">{{ number_format($purchaseorder->PurchaseRequest->pr_total,2) }} MYR</span>
                            </td>
                            <!--end::Price=-->
                            <!--begin::Status=-->
