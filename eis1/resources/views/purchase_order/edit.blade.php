                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--begin::Input group-->
                                        <select name="po_prID" class="form-select mb-5" id="selectPR">
                                            <option value="{{ $purchaseOrder->po_prID }}" selected="selected">{{ $purchaseOrder->PurchaseRequest->pr_no }}</option>
                                        </select>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group mb-5">
                                            <input name="po_paymentTerm" type="number" value="{{ $purchaseOrder->po_paymentTerm }}" class="form-control" placeholder="Payment Term">
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <textarea name="po_deliveryTo" class="form-control form-control" rows="4" placeholder="Delivery To">{{ $purchaseOrder->po_deliveryTo }}</textarea>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
