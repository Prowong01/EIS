                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group mb-5">
                                            <input name="po_paymentTerm" type="number" class="form-control" placeholder="Payment Term">
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <textarea name="po_deliveryTo" class="form-control form-control" rows="4" placeholder="Delivery To">TSK SYNERGY SDN BHD&#10;NO. 19, JALAN MEGA 1/8 TAMAN PERINDUSTRIAN NUSA CEMERLANG 79200 ISKANDAR PUTERI JOHOR.</textarea>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
